...
> [!IMPORTANT]
> **Objectif Global**: Permettre aux participants de former leur propre opinion sur le LEAN et de découvrir ses fondamentaux à travers une expérience pratique, ludique et rythmée. Cette journée alterne théorie et simulation pour transformer la perception du travail en équipe.

---

## 📋 Informations Pratiques

**Public cible**: Salariés d'entreprise (tous niveaux hiérarchiques)  
**Durée totale**: 7h30 (pause déjeuner incluse)  
**Nombre de participants**: 8 à 16 personnes (idéalement 12)  
**Organisation**: Groupes de 4 à 6 personnes par ligne de production  
**Formateur(s)**: 1 à 2 coachs LEAN

### Matériel Nécessaire

- **Par participant**: 100 feuilles A4 blanches (80g/m²)
- **Par ligne**: 1 chronomètre, 1 tableau d'indicateurs, des marqueurs
- **Collectif**: 1 paperboard, post-its de couleurs, scotch, feutres
- **Support visuel**: Affiche des 8 gaspillages, Fiche d'Instruction au Poste (FIP), diagrammes Yamazumi vierges

---

## 🌅 MATIN : Sortir du Chaos de la Masse (09h00 - 12h30)
...
- Les participants écrivent à l'intérieur de leur cocotte:
  ...
  - **Volet 3**: Un challenge rencontré dans leur travail quotidien
  - **Volet 4**: Un objectif d'apprentissage
...
- **MUDA** (Gaspillages): Tout ce qui n'apporte pas de valeur au client
  - Présentation visuelle des **8 gaspillages**:
    ...
    7. Défauts/correction
    8. Sous-utilisation des compétences
  
- **MURI** (Surcharge): Demander plus que les capacités disponibles
...
- Démonstration en direct par le formateur:
  ...
  2. **Étape 1**: Les diagonales
  3. **Étape 2**: Le 1er Blintz (4 coins au centre)
  4. **Étape 3**: Le retournement
  5. **Étape 4**: Le 2ème Blintz
  6. **Étape 5**: Le pré-formage
...
- Établissement des **3 critères de validation**:
  ...
  2. **Mobilité**: S'ouvre et se ferme sans résistance
...
- Découpage du processus en **5 postes de travail**:
  ...
  - **Poste 2**: Diagonales + 1er Blintz
  - **Poste 3**: Retournement + 2ème Blintz
  - **Poste 4**: Pré-formage
  - **Poste 5**: Ouverture + Contrôle Qualité
- Chaque équipe nomme un responsable et un contrôleur qualité

---

### ☕ **PAUSE** ⏱️ 10h45 - 11h00 (15 min)
...
- Le formateur observe sans intervenir:
  ...
  - Stress visible des opérateurs
  - Défauts de fabrication
  - Poste goulot d'étranglement
...
- Comptage:
  ...
  - Nombre de cocottes en-cours (par poste)
  - Nombre de défauts détectés
- Calcul du **Lead Time moyen**: Temps total / Cocottes finies
- Mesure du **WIP** (Work In Progress): Total des en-cours
...
- Faire identifier les **8 gaspillages** présents:
  ...
  - Stocks (en-cours massifs)
  - Mouvements inutiles (chercher de la place)
  - Défauts (trouvés tard)
  - Sur-processus (refaire les défauts)
  
- Introduire la notion de **Goulot d'étranglement**
- Visualisation: dessiner le flux sur le paperboard avec les stocks

##### Remplissage du Tableau KPI (Round 1)

| Indicateur | Round 1 (Flux Poussé) |
|:-----------|:---------------------|
| **Production totale** | ___ cocottes |
| **En-cours (WIP)** | ___ cocottes |
| **Lead Time moyen** | ___ secondes |
| **Qualité (% conformes)** | ___% |
| **Stress perçu** | ⭐⭐⭐⭐⭐ (Maximum) |

---

### 🍽️ **PAUSE DÉJEUNER** ⏱️ 12h00 - 13h00 (1h00)

**Consigne déjeuner**: "Réfléchissez: comment pourriez-vous améliorer le processus?"

---

## 🌞 APRÈS-MIDI : La Fluidité et l'Efficience (13h00 - 17h00)
...
- **Loi de Little**: Lead Time = WIP / Débit
...
- Chaque poste reçoit 2 cartes Kanban
...
- Calcul au tableau:
  ...
  - Lead Time passe de 50 min à 5 min!

##### Remplissage du Tableau KPI (Round 2)

| Indicateur | Round 1 | Round 2 (Flux Tiré) |
|:-----------|:-------:|:-------------------:|
| **Production totale** | ___ | ___ |
| **En-cours (WIP)** | Élevé | **Faible** |
| **Lead Time moyen** | Très long | **Court** |
| **Qualité (% conformes)** | ___% | ___% (Meilleur) |
| **Stress perçu** | ⭐⭐⭐⭐⭐ | ⭐⭐⭐ |
...
- Construction du diagramme Yamazumi sur paperboard:
  ...
  - Axe horizontal: Postes 1 à 5
  - Barre horizontale: Takt Time cible
  
**Exemple de Yamazumi Round 2:**
...
Temps (sec)
   ...
   10│  ████   █████  ████  ████  ████
    0└─────┬────┬────┬────┬────┬────
      ...
      Takt Time = 35 sec (ligne en pointillé)
```
...
- **Seiketsu** (Standardiser): Photographier la disposition (standard visuel)
...
**16h00 - 16h15** | Tableau comparatif final

| Indicateur | Round 1 (Poussé) | Round 2 (Tiré) | Round 3 (Optimisé) |
|:-----------|:----------------:|:--------------:|:------------------:|
| **Production totale** | 45 | 52 | 68 |
| **En-cours (WIP)** | 48 | 8 | 2 |
| **Lead Time moyen** | 18 min | 5 min | 2 min |
| **Qualité (% conformes)** | 62% | 85% | 96% |
| **Stress perçu** | ⭐⭐⭐⭐⭐ | ⭐⭐⭐ | ⭐⭐ |
| **Collaboration** | Faible | Moyenne | Excellente |

*Remarque: Les chiffres ci-dessus sont des exemples types.*

**16h15 - 16h30** | Introduction du TRS
...
- **Disponibilité**: Temps effectif / Temps d'ouverture
  - Temps d'ouverture = 20 min = 1200 sec
  - Temps effectif = 1200 - pannes/pauses = 1150 sec
  - **Disponibilité = 1150/1200 = 95,8%**

- **Performance**: Cadence réelle / Cadence théorique
  - Production réelle = 68 cocottes
...
4. **Une amélioration possible** (Kaizen concret)

Partage en plénière (2 min par groupe).
...
**16h55 - 17h00** | Message final du formateur
...
- Remise d'un **livret mémo** (synthèse des concepts)
- Photo de groupe avec les cocottes
- Questionnaire de satisfaction (QCM rapide ou digital)

---

## 📊 Annexes pour le Formateur

### Liste de Contrôle Pré-Formation

- [ ] Photocopier la Fiche d'Instruction au Poste (FIP) en A3
- [ ] Imprimer les affiches des 8 gaspillages
- [ ] Préparer les cartes Kanban (vertes et rouges)
- [ ] Tester le pliage cocotte en amont (s'assurer de la qualité du papier)
- [ ] Préparer les chronomètres et tableaux de bord vierges
- [ ] Commander les markers, post-its, scotch
- [ ] Vérifier la salle: tables mobiles pour réorganisation
- [ ] Prévoir vidéoprojecteur pour la vidéo Toyota
...
2. ✅ Identifier 5 des 8 gaspillages dans leur environnement
3. ✅ Expliquer la différence entre flux poussé et flux tiré
4. ✅ Comprendre l'impact du WIP sur le Lead Time (Loi de Little)
5. ✅ Proposer au moins une amélioration concrète pour leur poste
6. ✅ Comprendre que le LEAN est avant tout un état d'esprit
...
Pour toute question ou adaptation du scénario à votre contexte:  
**[Coordonnées du formateur à compléter]**

---

*Document créé le 26 janvier 2026*  
*Version 1.0 - Scénario Atelier Cocotte LEAN - Formation 1 Jour*
