# Module 1 : Plans de Contrôle et Gammes de Contrôle
...
1. **Identifier** les différents types de contrôle dans un processus industriel
2. **Élaborer** un plan de contrôle conforme aux exigences APQP/PPAP
3. **Créer** une gamme de contrôle opérationnelle
4. **Analyser** les risques processus avec la méthode AMDEC
5. **Déterminer** les points de contrôle critiques
6. **Utiliser** Excel pour créer et gérer des plans de contrôle

---

## 📅 JOUR 1 - Introduction au Contrôle Qualité et Plans de Contrôle

### 🌅 MATIN (3h30) - 09h00-12h30

#### Séquence 1.1 : Accueil et Introduction (30 min) - 09h00-09h30
...
- Règles de fonctionnement (horaires, pauses, évaluation)
- Organisation matérielle (accès WiFi, logiciels)
...
#### Séquence 1.2 : Les Fondamentaux du Contrôle Qualité (1h30) - 09h30-11h00

**Objectif** : Comprendre le rôle du contrôle dans le système qualité
...
**Méthode pédagogique** : Exposé participatif + travail en sous-groupes

**Support** : Module1_Support_Stagiaire.md (Section 1)
...
#### Séquence 1.3 : Introduction aux Plans de Contrôle (1h15) - 11h15-12h30

**Objectif** : Comprendre la structure et l'utilité d'un plan de contrôle
...
**Support** : Module1_Support_Stagiaire.md (Section 2)

---

### 🌆 APRÈS-MIDI (3h30) - 13h30-17h00

#### Séquence 1.4 : Élaboration d'un Plan de Contrôle - Méthodologie (1h00) - 13h30-14h30

**Objectif** : Maîtriser la démarche d'élaboration d'un plan de contrôle
...
1. **Les 7 étapes de création**
   ...
   4. Choisir les méthodes de mesure
...
**Support** : Module1_Support_Stagiaire.md (Section 3)

---

#### Séquence 1.5 : TP1 - Création d'un Plan de Contrôle avec Excel (2h15) - 14h30-16h45

**Objectif** : Créer un plan de contrôle opérationnel avec Excel
...
2. Découpe laser
3. Pliage
4. Taraudage (filetage)
5. Traitement de surface (peinture)
6. Contrôle final
...
#### ☕ PAUSE (15 min) - 16h45-17h00

---

#### Séquence 1.6 : Débriefing et Questions (15 min) - 17h00-17h15
...
**Méthode** : Discussion interactive

---

## 📅 JOUR 2 - AMDEC Processus et Gammes de Contrôle

### 🌅 MATIN (3h30) - 09h00-12h30

#### Séquence 2.1 : Rappel J1 et Introduction AMDEC (15 min) - 09h00-09h15
...
**Méthode** : Quiz interactif (Kahoot ou papier)

---

#### Séquence 2.2 : L'AMDEC Processus - Théorie (1h45) - 09h15-11h00

**Objectif** : Comprendre et savoir conduire une AMDEC Processus
...
**Support** : Module1_Support_Stagiaire.md (Section 4)
...
#### Séquence 2.3 : Démonstration AMDEC avec Excel (1h15) - 11h15-12h30
...
- Tri et filtres pour prioriser

**Cas démontré** : Processus d'assemblage (vissage automatique)

**Méthode pédagogique** : Démonstration vidéoprojetée + explications

**Note pour le formateur** : Les stagiaires observent, prennent des notes. Ils reproduiront l'après-midi.

---

### 🌆 APRÈS-MIDI (3h30) - 13h30-17h00

#### Séquence 2.4 : TP2 - Réaliser une AMDEC Processus (2h00) - 13h30-15h30

**Objectif** : Conduire une AMDEC complète en autonomie
...
- Calculer les IPR
- Proposer un plan d'action pour IPR > 125
...
#### ☕ PAUSE (15 min) - 15h30-15h45

---

#### Séquence 2.5 : Les Gammes de Contrôle (1h15) - 15h45-17h00

**Objectif** : Comprendre et créer une gamme de contrôle opérationnelle
...
3. **Structure d'une gamme de contrôle**
   ...
   - Corps :
     ...
     * Moyen de contrôle (avec référence)
     * Mode opératoire (comment mesurer ?)
     * Fréquence
     * Enregistrement
...
**Méthode pédagogique** : Exposé + analyse documentaire

**Support** : Module1_Support_Stagiaire.md (Section 5)

---

## 📅 JOUR 3 - Cas Pratiques et Évaluation

### 🌅 MATIN (3h30) - 09h00-12h30

#### Séquence 3.1 : Rappel J2 et TP3 - Introduction (15 min) - 09h00-09h15
...
#### Séquence 3.2 : TP3 - Créer une Gamme de Contrôle Complète (2h45) - 09h15-12h00

**Objectif** : Élaborer une gamme de contrôle opérationnelle et réaliste
...
#### ☕ PAUSE (15 min) - 12h00-12h15

---

#### Séquence 3.3 : Synthèse TP3 et Transition (15 min) - 12h15-12h30

**Objectif** : Ancrer les apprentissages et préparer les cas pratiques

---

### 🌆 APRÈS-MIDI (3h30) - 13h30-17h00

#### Séquence 3.4 : Cas Pratique 1 - Industrie Automobile (1h30) - 13h30-15h00

**Objectif** : Appliquer l'ensemble des compétences du module sur un cas réel
...
- Ébaucher les gammes de contrôle critiques

**Travail** : Groupes de 3-4 personnes

**Restitution** : Présentation PowerPoint ou sur paperboard (10 min par groupe)

---

#### ☕ PAUSE (15 min) - 15h00-15h15

---

#### Séquence 3.5 : Cas Pratique 2 - Industrie Aéronautique (1h15) - 15h15-16h30

**Objectif** : Traiter un cas avec exigences renforcées (aéronautique)
...
- Plans de réaction stricts

**Travail** : Mêmes groupes que Cas Pratique 1

**Restitution** : Présentation + questions du formateur

---

#### Séquence 3.6 : Évaluation Formative Module 1 (30 min) - 16h30-17h00
...
- Exercice pratique court - 20 min
  ...
  * À compléter : 3 lignes d'AMDEC + 1 ligne de plan de contrôle

**Critères** : Voir Evaluations.md

**Debriefing** : Correction immédiate + feedback

---

#### Séquence 3.7 : Clôture Module 1 et Transition Module 2 (15 min) - 17h00-17h15
...
- Présentation rapide du Module 2 (Statistiques et Capabilité)
- Informations pratiques si module non consécutif

**Méthode** : Tour de table + exposé
...
- **Module1_Guide_Formateur.md** : Notes pédagogiques détaillées
- **Module1_Support_Stagiaire.md** : Support de cours complet
- **TP1, TP2, TP3** : Énoncés et corrigés
- **Cas Pratiques 1 et 2** : Mises en situation
...
- Adapter les exemples au secteur d'activité des stagiaires quand possible
- Privilégier les cas réels apportés par les stagiaires (si pertinent)
- Insister sur le lien AMDEC → Plan de contrôle → Gamme de contrôle
- Prévoir du temps pour les questions, le public BAC/BTS peut être hésitant
- Valider la maîtrise d'Excel en amont ou prévoir un rappel
